...
public class LocationBitboard {
    private Map<String, long[]> pieceBitboards = new HashMap<>();  // used for the UI. keys: stringnames of pieces, longarray
    ...
    public Map<String, Long> getAllPieces() {
        ...
        return bitboards;  // returns hashmap of Pieces and their respective Longs
    }
    ...
    // setter method to update new piece location after move in UI
